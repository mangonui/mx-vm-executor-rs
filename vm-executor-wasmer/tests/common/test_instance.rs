...
pub const DUMMY_COMPILATION_OPTIONS: CompilationOptionsLegacy = CompilationOptionsLegacy {
    gas_limit: 0,
    unmetered_locals: 0,
    max_memory_grow: 0,
...
-> Box<dyn multiversx_chain_vm_executor_wasmer::executor_interface::ExecutorLegacy> {
